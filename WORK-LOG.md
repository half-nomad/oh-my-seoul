...
**법적 문서 추가 - 개인정보처리방침 & 이용약관**

### 주요 기능
- ✅ **개인정보처리방침**: 행동 데이터 수집, 익명화 처리 명시
- ✅ **이용약관**: 외부 링크 면책, 저작권 보호 조항
- ✅ **법적 페이지**: /privacy, /terms
- ✅ **Footer 링크**: 모든 페이지 하단에 법적 문서 링크 추가

### 비즈니스 모델 정의
- 개인정보 수집 최소화 (IP 주소만)
- 행동 데이터 익명화 후 B2B 통계 제공
- 제휴사 링크 노출 (외부 사이트)
- 리타게팅 광고 없음 (유입 광고만)
...
* components/Footer.tsx         (법적 링크 추가, v1.1.0)
```

### Git
- **Tag**: v1.1.0
- **Commits**: 8d384a0, 0e6cf1d
